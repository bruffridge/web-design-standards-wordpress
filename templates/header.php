  ...
  <div class="usa-banner">
    <div class="usa-accordion">
      <header class="usa-banner-header">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/dist/img/favicons/favicon-57.png" alt="NASA logo">
        <p>An official website of NASA</p>
      ...
      <div class="usa-banner-content usa-grid usa-accordion-content" id="gov-banner">
        <div class="usa-banner-guidance-gov usa-width-one-half">
          <img class="usa-banner-icon usa-media_block-img" src="<?php echo get_template_directory_uri(); ?>/dist/img/icon-dot-gov.svg" alt="Dot gov">
        ...
        <div class="usa-banner-guidance-ssl usa-width-one-half">
          <img class="usa-banner-icon usa-media_block-img" src="<?php echo get_template_directory_uri(); ?>/dist/img/icon-https.svg" alt="SSL">
          <div class="usa-media_block-body">
  ...
  <nav role="navigation" class="usa-nav">
    <div class="usa-nav-inner">
      <button class="usa-nav-close">
        <img src="<?php echo get_template_directory_uri(); ?>/dist/img/close.svg" alt="close">
      </button>
    <?php
      if (has_nav_menu('primary_navigation')) :
              ...
              'link_after' => '</span>',
							...
							'walker' => new wp_nasawds_navwalker()
						));
